...
class BookingTests(APITestCase):
    def setUp(self):
        ...
        self.payload = {'pool': self.pool_url,
                        'user': self.user_url,
    ...
    def test_book_a_pool(self):
        ...
        self.assertEqual(from_json.get('start_datetime'),
                         self.start.strftime('%Y-%m-%dT%H:%M:%S.%fZ'))
        self.assertEqual(from_json.get('end_datetime'),
    ...
    def test_book_pool_not_authenticated(self):
        ...
        from_json = json.loads(response.content)
        self.assertEqual(from_json.get('detail'),
    ...
    def test_book_a_pool_invalid_url(self):
        ...
        """
        self.payload = {'pool': 'http://testserver/api/v1/vie',
        ...
        from_json = json.loads(response.content)
        self.assertEqual(from_json.get('pool'),
                         ['Invalid hyperlink - No URL match.'])
        self.assertEqual(from_json.get('user'),
                         ['Invalid hyperlink - No URL match.'])
    ...
    def test_book_a_pool_invalid_dates(self):
        ...
        """
        self.payload = {'pool': self.payload['pool'],
    ...
    def test_book_a_pool_null_payload(self):
        ...
        self.assertEqual(from_json.get('user'),
                         ['This field may not be null.'])
        self.assertEqual(from_json.get('start_datetime'), ["Datetime has wrong format. Use one of these formats instead: YYYY-MM-DDThh:mm[:ss[.uuuuuu]][+HH:MM|-HH:MM|Z]."])
        self.assertEqual(from_json.get('end_datetime'), ["Datetime has wrong format. Use one of these formats instead: YYYY-MM-DDThh:mm[:ss[.uuuuuu]][+HH:MM|-HH:MM|Z]."])
...
class RatingsTest(APITestCase):
    ...
    def test_rate_pool_invalid_value1(self):
        ...
        from_json = json.loads(response.content)
        self.assertEqual(from_json.get('value'), ["Ensure this value is less than or equal to 5.0."])
    ...
    def test_rate_pool_invalid_value2(self):
        ...
        from_json = json.loads(response.content)
        self.assertEqual(from_json.get('value'),
